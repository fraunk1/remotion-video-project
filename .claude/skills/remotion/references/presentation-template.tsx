/**
 * Remotion Presentation-Style Video Template
 *
 * Usage: Copy this file into your Remotion project's src/compositions/ directory.
 * Register the <Presentation> component in Root.tsx as a Composition.
 *
 * Customize: Edit the THEME, SLIDES array, and individual slide components.
 */
...
// Slide data — add, remove, or reorder slides here
const SLIDES = [
  {
    type: "title" as const,
  ...
  },
  {
    ...
    leftContent: "Our market share grew from 12% to 18% in the enterprise segment, driven by our AI-powered features.",
...
const renderSlide = (slideData: (typeof SLIDES)[number]) => {
  switch (slideData.type) {
    case "title":
      return <TitleSlide title={slideData.title} subtitle={slideData.subtitle} />;
    case "bullets":
      return <BulletSlide title={slideData.title} bullets={slideData.bullets} />;
    case "twoColumn":
      return (
        <TwoColumnSlide
          title={slideData.title}
          leftContent={slideData.leftContent}
          rightLabel={slideData.rightLabel}
          rightValue={slideData.rightValue}
        />
      );
    case "quote":
      return <QuoteSlide quote={slideData.quote} attribution={slideData.attribution} />;
    case "closing":
      return <ClosingSlide title={slideData.title} subtitle={slideData.subtitle} />;
    default:
      return null;
  }
};
...
//   durationInFrames={810}  // Sum of all slide durations minus overlapping transitions
//   fps={30}
//   width={1920}
//   height={1080}
// />
