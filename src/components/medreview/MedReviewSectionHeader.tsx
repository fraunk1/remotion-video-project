...
/**
 * Section header (slides 4, 9, 12). Full-bleed swoosh + animated part
 * label + title + rule + subtitle reveal. Color prop toggles blue/orange.
 */
export const MedReviewSectionHeader: React.FC<{
  partLabel: string;
  title: string;
  subtitle?: string;
  color: "blue" | "orange";
