...
/**
 * Slide 1: title. Italic orange "Med" + navy "Review" as hero wordmark,
 * blue subtitle, FSMB meta.
 */
export const MedReviewTitle: React.FC = () => {
  ...
  return (
    <MedReviewContainer background="swoosh-corner" padding={0}>
      ...
      >
        ...
        >
          Regulatory Innovation &amp; Member Services
        </div>
        ...
        >
          <span style={{ fontStyle: "italic", color: t.colors.orange }}>Med</span>
          <span>Review</span>
        </div>
        ...
        >
          AI-Assisted Medical Records Review
        </div>
        ...
        >
          ...
          <div style={{ marginTop: 10, opacity: 0.85 }}>
            Federation of State Medical Boards · 2026
          </div>
        </div>
      </div>
    </MedReviewContainer>
